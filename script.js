const informationBox = document.getElementById(
  "top-cointainer-information-balance-box"
);
...
function renderListItem(type, itemData) {
  ...
  item.classList.add("container-accounting-list-item");
  let span = document.createElement("span");
  span.classList.add("container-accounting-list-item-amount");
  ...
  createEditBtn.classList.add("edit-btn", "btn-pointer");
  let createDeleteBtn = document.createElement("button");
  createDeleteBtn.textContent = "Usuń";
  createDeleteBtn.classList.add("delete-btn", "btn-pointer");
...
function updateBalance() {
  ...
  document.getElementById(
    "income-total"
  ).textContent = `Suma przychodów: ${totalIncomes.toFixed(2)} zł`;
  document.getElementById(
    "expense-total"
  ).textContent = `Suma wydatków: ${totalExpenses.toFixed(2)} zł`;
